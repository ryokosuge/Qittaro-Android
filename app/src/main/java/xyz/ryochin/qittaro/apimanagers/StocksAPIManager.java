...
public class StocksAPIManager {

    private static final String TAG = StocksAPIManager.class.getSimpleName();
    private final StocksAPIManager self = this;

    private static final String API_URL = "https://qiita.com/api/v1/stocks";
    private static final int PER_PAGE = 20;

    private static StocksAPIManager instance;
    private int page;
    ...
    public static StocksAPIManager getInstance() {
        if (instance == null) {
            instance = new StocksAPIManager();
        }
        return instance;
    }

    private StocksAPIManager() {
        this.page = 1;
        this.loading = false;
        this.token = null;
