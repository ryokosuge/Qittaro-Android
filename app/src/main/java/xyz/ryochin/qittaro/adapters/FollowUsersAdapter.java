...
public class FollowUsersAdapter extends BaseAdapter {
    ...
    private static class ViewHolder {
        ...
        public ViewHolder(View v) {
            this.userIconImageView = (ImageView)v.findViewById(R.id.follow_user_detail_icon);
            this.userNameTextView = (TextView)v.findViewById(R.id.follow_user_detail_url_name);
        }
    }
    ...
    public void addItem(FollowUserModel item) {
        this.items.add(item);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.e(TAG, "userName = " + model.getUrlName());
        Log.e(TAG, "profileImageURL = " + model.getProfileImageURL());
