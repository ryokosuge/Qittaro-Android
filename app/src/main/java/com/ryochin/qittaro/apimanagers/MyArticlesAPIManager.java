...
public class MyArticlesAPIManager {

    private static final String TAG = MyArticlesAPIManager.class.getSimpleName();
    private final MyArticlesAPIManager self = this;
    private static final String API_URL = "https://qiita.com/api/v1/items";
    private static final int PER_PAGE = 20;

    private static MyArticlesAPIManager instance;
    private int page;
    ...
    public static MyArticlesAPIManager getInstance() {
        if (instance == null) {
            instance = new MyArticlesAPIManager();
        }
        return instance;
    }

    private MyArticlesAPIManager() {
        this.page = 1;
        this.loading = false;
        this.max = false;
